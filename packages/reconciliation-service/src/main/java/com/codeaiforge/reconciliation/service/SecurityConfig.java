 ...
 *
 * <p>See ADR-0105 (docs/adr/0105-unauthenticated-health-endpoint.md) for why health is
 ...
 * replace this class, carrying the ADR-0105 rule forward. Do not build on it.
 */
@Configuration
